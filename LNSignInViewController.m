...
- (void)facebookLogin:(id)sender
{
	...
	[_identityManager authenticateIdentityWithServiceIdentifier:@"fb" reuseSlot:YES completion:^(LNUser *user) {
		[self hideHUD:NO];
		if (user) {
...
{
	[self displayHUD:@"Authenticating..."];
	[_identityManager authenticateIdentityWithServiceIdentifier:@"tw" reuseSlot:YES completion:^(LNUser *user) {
		[self hideHUD:NO];
		if (user) {
